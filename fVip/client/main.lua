...
Citizen.CreateThread(function()
    ...
    TriggerServerEvent("fVip:requestVipLevel")
end)

RegisterNetEvent("fVip:callbackVipLevel")
AddEventHandler("fVip:callbackVipLevel", function(incomingVipLevel)
...
RegisterCommand("vip", function(source)
    if vipLevel <= 0 then
        ESX.ShowNotification("~r~Vous n'avez pas la permission d'executer cette commande, veuillez visiter notre boutique via notre discord !")
        return
    end
    isMenuActive = true
    ...
    Citizen.CreateThread(function()
        while isMenuActive do
            ...
            RageUI.IsVisible(RMenu:Get("vip", "vip_menu"), true, true, true, function()
                ...
                RageUI.ButtonWithStyle("Apparences peds", "Vous permets de vous métamorphosé en ped", {}, true, function(_,_,s)
